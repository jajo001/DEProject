...
# full
# testread = ReadYaml("C:/Users/aleks/OneDrive/Desktop/DEProject/conf/toDV/dvdrental/full.yaml", 'dvdrental.store')
...
testread = ReadYaml("C:/Users/aleks/OneDrive/Desktop/DEProject/conf/toDV/dvdrental/incremental.yaml", 'dvdrental.rental')
test = ToDV(testread.path, testread.key)
...
# clean staging
# cleantestread = ReadYaml("C:/Users/aleks/OneDrive/Desktop/DEProject/conf/toStaging/dvdrental/full.yaml", 'public.category')
# t = CleanStaging()
